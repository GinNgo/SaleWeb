...
@Component({
  selector: 'app-combo-box-customer',
  templateUrl: './combo-box-customer.component.html',
  styleUrls: ['./combo-box-customer.component.scss'],
})
export class ComboBoxCustomerComponent implements OnInit {
  @Input()
  list: string[] = [];
  @Input()
  values: any = '';
